...
var transporter = nodemailer.createTransport({
  service: 'Gmail',
  auth: {
    user: 'marvailmorrisdeveloper@gmail.com',
    pass: 'ilovecode1'
  }
});
...
function sendMail(mailData){
  ...
  var mailOptions = {
    from: 'Marvail ✔ <marvailmorrisdeveloper@gmail.com>', // sender address
    to: 'marvailmorrisdeveloper@gmail.com, bailey1.brandon@gmail.com ' + mailData.email, // list of receivers
